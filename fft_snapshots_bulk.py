...
def processDensity(density,x,y,densityName,subtract=False,frac=1.0,ne=None):
    ...
    if subtract:
        ...
        density = (density[0:]/expDensity - 1.0)
...
#    parser.add_argument('--spatialY',type=float,nargs=2)
    ...
    if args.animate:
    ...
    elif args.singleSnapshot is True:
        #fig.suptitle(args.dataName.replace('_','\_'))
        sdfFile = args.fName
        
        print(sdfFile,sdfFile,sdfFile,sdfFile,sdfFile)
        ...
        print(xlims0,xlims1,'xlims0,xlims1 [um]')
        ...
        if 'Field_' or 'Poynting_' in args.dataName:
            if args.animate:
                ...
                if args.plotType == 'normal':
                    im=plotField(fig,ax,data,x,y,t,args.dataName,**plotArgs)
            ...
            if args.animate:
                ...
                if args.plotType == 'normal':
                    im=plotDensity(fig,ax,data,x,y,t,args.dataName,grid=True,**plotArgs)
                elif args.plotType == 'FT':
...
# =============================================================================
    ...
    elif args.singleSnapshot is not True:
...
#    parser.add_argument('--spatialY',type=float,nargs=2)
    ...
    # Find data
        ...
        for i in range(1,args.IntervalFinal-1):
